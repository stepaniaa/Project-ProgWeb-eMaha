...
<html lang="en">
  ...
  <body>
      <div class="container-fluid d-flex justify-content-center align-items-center border vh-100">
        <div class="card w-30">
            <div class="card-header bg-primary justify-content-center"><strong class="text-light">FORM REGSITER</strong></div>
            <div class="card-body">
                <form action="/simpan" method="POST">
                    ...
                    <div class="form-group">
                        <label>No. Hp</label>
                        <input type="text" name="no_hp" placeholder="Masukan no. hp" class="form-control" required>
                    </div>
